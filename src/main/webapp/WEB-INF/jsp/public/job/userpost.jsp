		...
		<div class="chia2">
			<div class="danh-muc">
				...
				<ul>
					...
					<li class="category-list"><span class="category-span"><a
							...
							href="/job/user-post">Tôi đăng tuyển</a></span></li>
				</ul>
			</div>
			...
			<div class="dang-tin">
				...
				<c:if test="${not empty msg}">
					...
					<div id="wait"
						style="display: none; width: 120px; height: 120px; position: absolute; top: 50%; left: 47%; padding: 2px; z-index: 3">
						<img src='/resources/templates/loading8.gif' width="100"
							height="100" />
					</div>
